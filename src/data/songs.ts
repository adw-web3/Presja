...
export const songs: Song[] = [
  {
    ...
    title: "Preludium",
    slug: "preludium",
    story: "Głęboki wdech przed falą presji",
    lyrics: {
  ...
  },
  {
    ...
    title: "Czasu",
    slug: "czasu",
    story: "Presja czasu to codzienna walka z zegarem, który nieustannie odmierza chwile naszego życia.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Finansowa",
    slug: "finansowa",
    story: "Presja finansowa definiuje współczesne życie, gdzie pieniądze stają się miarą sukcesu.",
    lyrics: {
  ...
  },
  {
    ...
    slug: "rodziny",
    featuring: "wrona",
    story: "Presja rodziny to oczekiwania bliskich, które czasem ciążą bardziej niż cokolwiek innego.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Pracy",
    slug: "pracy",
    story: "Presja pracy to nieustanna pogoń za wynikami, awansem i uznaniem.",
    lyrics: {
  ...
  },
  {
    ...
    slug: "szkoly",
    featuring: "wrona",
    story: "Presja szkoły to system który kształtuje nas od najmłodszych lat.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Interludium",
    slug: "interludium",
    story: "Moment wytchnienia pomiędzy falami presji.",
    lyrics: {
      stanza1: "Tekst pierwszej zwrotki...\nCisza przed burzą\nSłowa opisujące początek",
  ...
  },
  {
    ...
    title: "Społeczna",
    slug: "spoleczna",
    story: "Presja społeczna to niewidzialne oczekiwania otoczenia.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Aplikacji",
    slug: "aplikacji",
    story: "Presja aplikacji to cyfrowe więzienie które sami sobie budujemy.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Podróży",
    slug: "podrozy",
    story: "Presja podróży to przymus zwiedzania świata dla zdjęć.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Pasji",
    slug: "pasji",
    story: "Presja pasji to obowiązek posiadania hobby które definiuje naszą wartość.",
    lyrics: {
  ...
  },
  {
    ...
    slug: "zdrowego-zycia",
    story: "Presja zdrowego życia to obsesja na punkcie ciała i diety.",
    lyrics: {
  ...
  },
  {
    ...
    title: "Migracji",
    slug: "migracji",
    story: "Presja migracji to ciężar opuszczenia domu w poszukiwaniu lepszego życia.",
    lyrics: {
  ...
  },
  {
    ...
    story: "Ostatnie słowa o presji, podsumowanie wszystkiego co było wcześniej.",
    lyrics: {
